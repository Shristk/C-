//WRITE A PROGRAM TO GIVE A SERIES OF QUESTIONS AND AFTER EACH QUESIONS ASK THE USERR IF HE WANTS TO CONTINUE OR NOT AND THEN AT LAST GIVE THE FINAL SCORE  
#include<iostream>
using namespace std;
#include<string>
int main()
